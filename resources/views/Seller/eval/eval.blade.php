...
@section('content')
    ...
    <table class="mws-datatable-fn mws-table dataTable" id="DataTables_Table_1" aria-describedby="DataTables_Table_1_info">
         <thead>
             <tr role="row">
                ...
                <th class="sorting" role="columnheader" tabindex="0" aria-controls="DataTables_Table_1" rowspan="1" colspan="1" aria-label="Browser: activate to sort column ascending" style="width: 224px;">店家名称
                </th>
   ...
   商家详情                    <td>{{ $v -> order }}</td>
                       ...
                       <td><button id="but" class="btn btn-primary" ><a href="{{url('seller/eval/'.$v->eid.'/edit')}}">查看</a></button></td>
                   </tr>       
               @endforeach
        </table>
