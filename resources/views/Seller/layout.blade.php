...
<div id="mws-wrapper">
    ...
    <div id="mws-sidebar">
        ...
        <div id="mws-navigation">
            <ul>
                <li>
                    <a href="#"><i class="icon-user"></i>我的店铺</a>
                    <ul class="opend">
                     <li><a href="{{ asset('seller/index/') }}/{{ session('master')['sid'] }}/edit">我的店铺</a></li>
                    </ul>
                </li>
            </ul>
        </div>
     <div id="mws-navigation">
            <ul>
                <li>
                    ...
                    <ul class="opend">
                        <li><a href="{{url('seller/goods')}}">商品列表</a></li>
                        <li><a href="{{url('seller/goods/create')}}">添加商品</a></li>
                    </ul>
                </li>
            </ul>
        </div>
        <div id="mws-navigation">
            <ul>
                <li>
                    ...
                    <ul class="opend">
                        <li><a href="{{url('seller/order')}}">订单列表</a></li>
                    </ul>
                </li>
            </ul>
        </div>
        <div id="mws-navigation">
            <ul>
                <li>
                    <a href="#"><i class="icon-list-2"></i>评价管理</a>
                    <ul class="opend">
                        <li><a href="{{url('seller/eval')}}">评价列表</a></li>
                    </ul>
                </li>
            </ul>
        </div>
        <div id="mws-navigation">
            <ul>
                ...
                <li>
                    <a href="#"><i class="icon-snowflake"></i> 地址管理</a>
                    <ul class="opend">
                        <li><a href="{{url('seller/advert')}}">具体位置</a></li>
                        <li><a href="{{url('seller/advert/create')}}">位置列表
                        </a></li>
                    </ul>
                </li>
            </ul>
