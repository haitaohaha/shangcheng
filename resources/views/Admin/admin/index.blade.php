                ...
                <table class="mws-datatable-fn mws-table dataTable" id="DataTables_Table_1" aria-describedby="DataTables_Table_1_info">
                    ...
                    @foreach($data as $k=>$v)
                        <tr>
                            <td>{{ $v['aid']}}</td>
                            <td>{{ $v['aname'] }}</td>
                            <td><img src="{{asset('uploads/images')}}/{{ $v['avatar'] }}" width="55px";height="75px"></td>
                            <td>{{ config('lyg_admin.auth')[$v['auth']] }}</td>
                            ...
                            <td>
                                ...
                                <a href="{{url('admin/admin/'.$v['aid'].'/edit')}}" title="修改" style="color:#000;font-size:20px;margin-right:15px;"><i class="icon-pencil-2"></i></a>
                            </td>
                        </tr>
                    @endforeach
                    </tbody>
