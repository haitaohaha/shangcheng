...
<div id="mws-wrapper">
    ...
    <div id="mws-sidebar">
     ...
     <div id="mws-navigation">
            ...
            <ul>
                <li>
                    <a href="#"><i class="icon-user"></i>商品列表</a>
                    <ul class="opend">
                        <li><a href="{{url('admin/goods/')}}">查看商品</a></li>
        ...
        <div id="mws-navigation">
            <ul>
                <li>
                    <a href="#"><i class="icon-align-center"></i> 商品分类</a>
                    <ul class="opend">
                        <li><a href="{{url('admin/goodsclass/create')}}">分类添加</a></li>
                        <li><a href="{{url('admin/goodsclass')}}">分类列表</a></li>
                    </ul>
                </li>
            </ul>
        </div>
        ...
        <div id="mws-navigation">
            <ul>
                ...
                <li>
                    <a href="#"><i class="icon-add-contact"></i> 商家审核</a>
                    <ul class="opend">
                        <li><a href="{{url('admin/examine')}}">审核列表</a></li>
                    </ul>
                </li>
            </ul>
        </div>
        <div id="mws-navigation">
            <ul>
                ...
                <li>
                    ...
                    <ul class="opend">
                        {{--<li><a href="">订单查看</a></li> --}}
                        <li><a href="{{url('/admin/order/')}}">订单商品</a></li> 
         ...
         <div id="mws-navigation">
            <ul>
                ...
                <li>
                    <a href="#"><i class="icon-list-2"></i>常见问题</a>
                    <ul class="opend">
                        <li><a href="{{url('/admin/Problem/')}}">问题列表</a></li> 
                    </ul>
                </li>
            </ul>
        </div>
          <div id="mws-navigation">
            <ul>
                ...
                <li>
                    <a href="#"><i class="icon-list-2"></i>评价</a>
                    <ul class="opend">
                        <li><a href="{{url('/admin/eval/')}}">评价列表</a></li> 
                    </ul>
                </li>
            </ul>
        </div>
         <div id="mws-navigation">
            <ul>
               <li>
                    <a href="#"><i class="icon-snowflake"></i>后台管理</a>
                    <ul class="opend">
                        <li><a href="{{url('/admin/admin')}}">管理列表</a></li> 
                        <li><a href="{{url('/admin/admin/create')}}">添加管理</a></li> 
                    </ul>
                </li>
            </ul>
        </div>
          <div id="mws-navigation">
            <ul>
                ...
                <li>
                    <a href="#"><i class="icon-list-2"></i>广告位</a>
                    <ul class="opend">
                        <li><a href="{{url('/admin/advert/')}}">广告位申请列表</a></li> 
                        <li><a href="{{url('/admin/adsense/')}}">广告位列表</a></li> 
                        <li><a href="{{url('/admin/adsense/create')}}">添加广告位</a></li> 
                    </ul>
                </li>
            </ul>
        </div>
        <div id="mws-navigation">
            <ul>
                ...
                <li>
                    <a href="#"><i class="icon-file-zip"></i>维修/退换</a>
                    <ul class="opend">
                        <li><a href="{{url('admin/service')}}">维修/退换</a>
                         </li>
                    </ul>
                </li> 
                </ul>
