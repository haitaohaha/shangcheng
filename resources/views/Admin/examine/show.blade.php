        ...
        <div class="mws-panel-body no-padding">
            <form class="mws-form" action="{{url('admin/examine').'/'.$data['sid']}}" method="post">
                ...
                <div class="mws-form-inline">
                    ...
                    <div class="mws-form-row">
                        <label class="mws-form-label">商家联系人:</label>
                        <div class="mws-form-item">
                            <p class="small" name="contacts" >{{$data['extel']}}</p>
                        </div>
                    </div>
                    ...
                    <div class="mws-form-row">
                        ...
                        <div class="mws-form-item">
                            <img src="{{url('/uploads/images')}}/{{ $data['eximage']}}" alt="">
                        </div> 
                    </div>
                    <div class="mws-form-row">
                        <label class="mws-form-label">营业执照:</label>
                        <div class="mws-form-item">
                            <img src="{{url('/uploads/images')}}/{{ $data['licencel']}}" alt="">
                        </div>
                    </div>
